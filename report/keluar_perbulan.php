            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h2>Sistem Informasi Surat Masuk Dan Surat Keluar Kantor Pajak Pratama Kisaran </h2>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM arsip_suratkeluar WHERE substr(tgl_keluar,1,7)='$ambilthn-$ambilbln'";
